...
**Status:** Draft (Phase H implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-h.md`; Section 10's 128-bit OID identity and allocation implemented and QEMU-proven as a follow-on scoped increment -- see `.agents/reports/aps-arcfs-oid-128bit.md`; Phase I implemented and QEMU-proven, scoped to file data extents -- see `.agents/reports/aps-arcfs-phase-i.md`; Phases J-M not yet begun)
