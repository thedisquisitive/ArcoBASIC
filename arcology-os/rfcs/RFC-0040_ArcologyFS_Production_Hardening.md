...
**Status:** Draft (Phase H implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-h.md`; Section 10's 128-bit OID identity and allocation implemented and QEMU-proven as a follow-on scoped increment -- see `.agents/reports/aps-arcfs-oid-128bit.md`; Phase I implemented and QEMU-proven, scoped to file data extents -- see `.agents/reports/aps-arcfs-phase-i.md`; Phase J implemented and QEMU-proven -- Object Tree AND Namespace Tree both real B+trees, Attribute Tree still a flat array (deferred to Phase L) -- see `.agents/reports/aps-arcfs-phase-j.md` and its own dated Addendum; Phase K implemented and QEMU-proven, scoped to real per-chunk extents and genuine sparse holes (not a true variable-count Extent Tree, offset-based I/O, or on-disk reflink sharing) -- see `.agents/reports/aps-arcfs-phase-k.md`; Phases L-M not yet begun)
