...
**Status:** Draft (Phases A-C implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-a.md`, `aps-arcfs-phase-b.md`, and `aps-arcfs-phase-c.md`; Phases D-G unstarted)
