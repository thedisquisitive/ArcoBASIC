...
**Status:** Draft (Phases A-F implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-a.md`, `aps-arcfs-phase-b.md`, `aps-arcfs-phase-c.md`, `aps-arcfs-phase-d.md`, `aps-arcfs-phase-e.md`, and `aps-arcfs-phase-f.md`; Phase G unstarted)
