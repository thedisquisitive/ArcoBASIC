...
**Status:** Draft (Phases A-D implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-a.md`, `aps-arcfs-phase-b.md`, `aps-arcfs-phase-c.md`, and `aps-arcfs-phase-d.md`; Phases E-G unstarted)
