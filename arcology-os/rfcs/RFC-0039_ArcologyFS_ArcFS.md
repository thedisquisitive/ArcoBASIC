...
**Status:** Draft (Phases A-E implemented and QEMU-proven -- see `.agents/reports/aps-arcfs-phase-a.md`, `aps-arcfs-phase-b.md`, `aps-arcfs-phase-c.md`, `aps-arcfs-phase-d.md`, and `aps-arcfs-phase-e.md`; Phases F-G unstarted)
