...
arco_add_script_test(
    systems_usb_hid_keyboard_driver_smoke
    arcology-os/tests/systems/systems_usb_hid_keyboard_driver_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
    systems_aps_arcology_seed_substrate_smoke
    arcology-os/tests/systems/systems_aps_arcology_seed_substrate_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
    systems_gop_mode_control_smoke
    arcology-os/tests/systems/systems_gop_mode_control_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
    systems_gpu_discovery_probe_smoke
    arcology-os/tests/systems/systems_gpu_discovery_probe_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
    systems_network_nic_discovery_probe_smoke
    arcology-os/tests/systems/systems_network_nic_discovery_probe_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
...
arco_add_script_test(
    systems_aex_manifest_probe_smoke
    arcology-os/tests/systems/systems_aex_manifest_probe_smoke.sh
    $<TARGET_FILE:ArcoFission>
    ${CMAKE_CURRENT_SOURCE_DIR}
)
arco_add_script_test(
