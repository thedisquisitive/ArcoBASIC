...
// virtual addresses are known (produced by the x86-64 code generator, arcology-os/docs/systems/
...
// the entry point at the start of .text (arcology-os/docs/systems/pe32-image.md). Patches every relocation in
