...
# see arcology-os/docs/systems/uefi-target.md section 10's "no new dependency" decision).
"$ARCOFISSION" reveal "$SOURCE_DIR/arcology-os/tests/fixtures/uefi-hello/hello.abas" at X86_64 > "$TMP_ROOT/hello.x86_64"
