...
"$SOURCE_DIR/arcology-os/scripts/build/build-arcology-hardware-artifact.sh" "$ARCOFISSION" "$TMP_ROOT/one" >/dev/null
"$SOURCE_DIR/arcology-os/scripts/build/build-arcology-hardware-artifact.sh" "$ARCOFISSION" "$TMP_ROOT/two" >/dev/null
