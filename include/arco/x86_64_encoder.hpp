...
// docs/systems/x86-64-codegen.md's lowering needs and nothing else. Every primitive here is
// verified byte-for-byte against `nasm -f bin` output (see tests/runtime_tests.cpp) rather than
