...
// Encodes UTF-8 source text as null-terminated UTF-16 (docs/systems/utf16-encoding.md), the
// CHAR16* string encoding required by UEFI's EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL.OutputString (see
// docs/systems/uefi-bindings.md). Rejects malformed UTF-8 and embedded NUL bytes (Packet WP-007
