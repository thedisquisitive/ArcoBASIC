// The generic host-function bridge for the native Linux backend (RFC-0053, "finish off Linux
...
extern "C" ArcoValue* arco_call_host(const uint16_t* name_utf16, ArcoValue* const* args, int64_t arg_count) {
    ...
    static arco::Runtime& runtime = [] () -> arco::Runtime& {
        ...
        // direct testing (RFC-0053, "full Linux support" pass): a native program calling an
