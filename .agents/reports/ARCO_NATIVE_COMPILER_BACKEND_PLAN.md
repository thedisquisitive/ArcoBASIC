...
platform infrastructure, not part of ArcoSH — see **RFC-0053**
(`arcology-os/rfcs/RFC-0053_Native_Hosted_ArcoBASIC_Compilation_and_System_Runtime.md`), the
authoritative design/scope document. This file remains the detailed phased *plan*; RFC-0053 is the
