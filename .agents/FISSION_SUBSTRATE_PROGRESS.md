...
2. Keep advancing Fission self-compilation by serializing semantic bindings
   through the executable module boundary, then attaching them to typed SIR nodes
   or a stable SIR semantic artifact.
