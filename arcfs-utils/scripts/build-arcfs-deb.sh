...
install -Dm0644 "$SOURCE_DIR/arcfs-utils/tools/arcfsctl.abas" "$PKG_ROOT/usr/share/arcobasic/tools/arcfsctl.abas"
install -Dm0644 "$SOURCE_DIR/arcfs-utils/apps/arconaut/arconaut.abas" "$PKG_ROOT/usr/share/arcobasic/examples/arconaut.abas"
