...
`arcology-commons/stdlib/arcology.abas` is the first domain module for The Arcology Commons. It
...
```basic
result = Arcology.ExportSite(app, "arcology-commons/dist/commons")
PRINT result.Path
```
