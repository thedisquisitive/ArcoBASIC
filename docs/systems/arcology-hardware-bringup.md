...
```text
dist/arcology-seed-0.1/BOOTX64.EFI
dist/arcology-seed-0.1/arcology-seed-0.1-x86_64.img
dist/arcology-seed-0.1/SHA256SUMS
```
...
```sh
(cd dist/arcology-seed-0.1 && sha256sum -c SHA256SUMS)
scripts/run-arcology-hardware-image.sh \
  dist/arcology-seed-0.1/arcology-seed-0.1-x86_64.img
```
...
sudo dd if=dist/arcology-seed-0.1/arcology-seed-0.1-x86_64.img \
