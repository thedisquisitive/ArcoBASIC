...
ARCH="${ARCH:-x86_64}"
OUT_DIR="${OUT_DIR:-$SOURCE_DIR/arcoalpha}"
...
Usage:
  scripts/build-void-native-package.sh [--void-packages DIR] [--out DIR] [--arch ARCH]

Environment:
  VOID_PACKAGES      void-packages checkout, default: ~/xbps/void-packages
  OUT_DIR            artifact output directory, default: ./arcoalpha
