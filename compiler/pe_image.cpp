...
// See docs/systems/pe32-image.md for the derivation and sources behind every constant and field
...
std::vector<std::uint8_t> write_pe32plus_efi_image(const MachineCodeImage& image) {
    ...
    // because SectionAlignment == FileAlignment (docs/systems/pe32-image.md "Alignment").
